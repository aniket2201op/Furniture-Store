...
<body>
    ...
    <?php
    $id = $_GET['bed_name'];
    $sql = "SELECT * FROM `kitchen_sets` WHERE kithcen_id=$id;";
  ...
  <div class="container-fluid">
    <a class="navbar-brand">Furniture Webshop</a>
    <a href="./logout.php" class="d-flex"><i class="fa-solid fa-arrow-right-from-bracket"></i>Log out</a>
  </div>
</nav>
    ...
    <div class="container my-4">
        <nav class="navbar bg-light">
            <div class="container-fluid">
                <a class="navbar-brand">Available Kitchen Sets</a>
            </div>
        </nav>
        <div class="jumbotron">
